(function (global, factory) {
  ...
  function slideVideo(slide, data, index, callback) {
    ...
    slideMedia.insertBefore(createHTML('<section class="gvideo-wrapper"></section>'), slideMedia.firstChild);
    ...
    injectAssets(this.settings.plyr.js, 'Plyr', function () {
      ...
      var placeholder = customPlaceholder ? customPlaceholder : createHTML("<section id=\"".concat(videoID, "\" data-plyr-provider=\"").concat(provider, "\" data-plyr-embed-id=\"").concat(url, "\"></section>"));
  ...
  function slideInline(slide, data, index, callback) {
    ...
    if (content) {
      if (isString(content)) {
        innerContent = createHTML("<section class=\"ginlined-content\">".concat(content, "</section>"));
      }
      if (isNode(content)) {
  ...
  var Slide = function () {
    ...
    return _createClass(Slide, [{
      ...
      value: function slideShortDesc(string) {
        ...
        var cleanedString = section.innerText;
  ...
  defaults.slideHTML = "<section class=\"gslide\">\n    <section class=\"gslide-inner-content\">\n        <section class=\"ginner-container\">\n            <section class=\"gslide-media\">\n            </section>\n            <section class=\"gslide-description\">\n                <section class=\"gdesc-inner\">\n                    <h4 class=\"gslide-title\"></h4>\n                    <section class=\"gslide-desc\"></section>\n                </section>\n            </section>\n        </section>\n    </section>\n</section>";
  defaults.lightboxHTML = "<section id=\"glightbox-body\" class=\"glightbox-container\" tabindex=\"-1\" role=\"dialog\" aria-hidden=\"false\">\n    <section class=\"gloader visible\"></section>\n    <section class=\"goverlay\"></section>\n    <section class=\"gcontainer\">\n    <section id=\"glightbox-slider\" class=\"gslider\"></section>\n    <button class=\"gclose gbtn\" aria-label=\"Close\" data-taborder=\"3\">{closeSVG}</button>\n    <button class=\"gprev gbtn\" aria-label=\"Previous\" data-taborder=\"2\">{prevSVG}</button>\n    <button class=\"gnext gbtn\" aria-label=\"Next\" data-taborder=\"1\">{nextSVG}</button>\n</section>\n</section>";
      ...
      value: function resize() {
        ...
        if (video) {
          ...
          if (!ratio) {
            ...
            var sectionisor = containerWidth / containerHeight;
            ratio = "".concat(containerWidth / sectionisor, ":").concat(containerHeight / sectionisor);
          }
